...
```{r}
# Signifikante genrer er Action, Biography, Crime, Documentary, Romance, SciFi, Sport, War, Western 

ggplot(data_significant, aes(x = after2017, y = bechdelRating, group = genre, color = genre)) +
